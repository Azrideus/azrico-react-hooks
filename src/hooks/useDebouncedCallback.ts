...
>(
    ...
    const maxWait = maxing ? Math.max(+(options.maxWait || 0), wait) : 9999999;
    ...
    const debounced = useMemo(() => {
        ...
        const func: DebouncedState<T> = function (
            this: any,
            ...args: Parameters<T>
        ): ReturnType<T> {
